...
def test_all_optimization_guards_pass():
    ...
    result = subprocess.run(  # noqa: S603
        [
            ...
            "-q",
            "--reuse-db",
            "podcasts/tests/test_refresh_service.py",
            "podcasts/tests/test_search_pure_read.py",
            "podcasts/tests/test_connection_reuse.py",
            "podcasts/tests/test_api.py",
            "podcasts/tests/test_views_features.py",
            "podcasts/tests/test_updater.py",
        ],
        cwd=str(REPO_ROOT),
        capture_output=True,
        text=True,
